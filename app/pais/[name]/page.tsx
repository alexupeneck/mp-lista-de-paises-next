...
export default async function CountryPage({
  ...
  return (
    <section className="flex flex-col container">
      ...
      <Link className="flex items-center py-2 text-white" href="/">
        <Image
          src="/back.png"
      ...
      <article className="flex md:flex-row flex-col justify-between min-w-full p-10 bg-slate-100 rounded-xl">
        <section>
          {country.capital && (
